...
<!--Second column-->
                          ...
                          <div class="col-lg-12">
                            <div class="description">
                                ...
                                <hr class="hr-dark">
                                <p class="wow fadeInLeft" data-wow-delay="0.4s">Professional caterers are experts at capturing those special moments in time that you want to keep forever. With the advanced technologies in digital photography and photo editing today, your photos can be viewed and edited in real-time</p>
                                <br>
...
<!--/.Mask-->
             ...
             <div class="divider-new" style="margin-top: 80px;">
                <h2 class="h2-responsive" id="caterer">caterer</h2>
            </div>
                            ...
                            <!--/.Card image-->
                             ...
                             <!--Card content-->
                                     <div class="card-block">
                                            <!--Title-->
                                            <h4 class="card-title">Wedding caterer</h4>
                                            <!--Text-->
                        ...
                        <div class="card">
                            ...
                            <!--/.Card image-->
                             ...
                             <!--Card content-->
                                     <div class="card-block">
                                            <!--Title-->
                                            <h4 class="card-title">Birthday caterer</h4>
                                            <!--Text-->
                                            <p class="card-text">Lagos, Nigeria</p>
                        ...
                        <div class="card">
                            ...
                            <!--/.Card image-->
                             ...
                             <!--Card content-->
                                     <div class="card-block">
                                            <!--Title-->
                                            <h4 class="card-title">Engagement caterer </h4>
                                            <!--Text-->
                                            <p class="card-text">Lagos, Nigeria</p>
                        ...
                        <div class="card">
                            ...
                            <!--/.Card image-->
                             ...
                             <!--Card content-->
                                     <div class="card-block">
                                            <!--Title-->
                                            <h4 class="card-title">Party caterer</h4>
                                            <!--Text-->
                                            <p class="card-text">Lagos, Nigeria</p>
