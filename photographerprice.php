    ...
    <style>
        ...
        .view {
           /* background: url("https://mdbootstrap.com/images/regular/city/img%20(6).jpg")no-repeat center center fixed;*/
             background: url("img/ph.jpg")no-repeat center center fixed;
...
<!--/.Mask-->
             ...
             <div class="divider-new" style="margin-top: 80px;">
                <h2 class="h2-responsive" id="photographer">Photographer</h2>
            </div>
                            ...
                            <!--/.Card image-->
                             ...
                             <!--Card content-->
                                     <div class="card-block">
                                            <!--Title-->
                                            <h4 class="card-title">Wedding Photographer</h4>
                                            <!--Text-->
                                            ...
                                            <center>
                                                <a class="btn btn-primary" name="weddingsuit">Select</a>
                                            </center>
                        ...
                        <div class="card">
                            ...
                            <!--/.Card image-->
                             ...
                             <!--Card content-->
                                     <div class="card-block">
                                            <!--Title-->
                                            <h4 class="card-title">Birthday Photographer</h4>
                                            <!--Text-->
                                            <p class="card-text">Lagos, Nigeria</p>
                        ...
                        <div class="card">
                            ...
                            <!--/.Card image-->
                             ...
                             <!--Card content-->
                                     <div class="card-block">
                                            <!--Title-->
                                            <h4 class="card-title">Engagement Photographer </h4>
                                            <!--Text-->
                                            <p class="card-text">Lagos, Nigeria</p>
                        ...
                        <div class="card">
                            ...
                            <!--/.Card image-->
                             ...
                             <!--Card content-->
                                     <div class="card-block">
                                            <!--Title-->
                                            <h4 class="card-title">Party Photographer</h4>
                                            <!--Text-->
                                            <p class="card-text">Lagos, Nigeria</p>
