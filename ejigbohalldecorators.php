                ...
                <ul class="nav navbar-nav smooth-scroll">
                    ...
                    <li class="nav-item">
                      ...
                      <a class="nav-link"><b style="font-size: 18px;"><?php if(isset($_SESSION['email'])){
                            echo $_SESSION['email'];
                            echo '<li>
                                    <form action="ejigbohalldecorators.php" method="POST" role="form">
        ...
        <div class="full-bg-img flex-center">
            <div class="container">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <center>   
                                    <h3 style="color:white; font-weight: bold; margin-top: 20px;">We have amazing Hall Decorators in Ejigbo Osun State for your event.</h3>
...
<center>   
                                    <h3 style=" font-weight: bold; ">Ejigbo Osun State Hall Decorators.</h3>
                                    
                                </center>

 <div class="container-fluid">
    <form role="form" action="ejigbohalldecorators.php" method="POST">
  <div class="row">
        <div class="col-md-3">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                                 <?php
                                $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 0,1";
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            ...
                            <?php
                                $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 1,1";
                                $result=mysqli_query($mysqli,$query);
                                 while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                             <?php
                                $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State'limit 2,1";
                                $result=mysqli_query($mysqli,$query);
                                while($row=mysqli_fetch_array($result)){
                         ...
                         <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                               <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 3,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                                 <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 4,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                                <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 5,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                              <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 6,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                             <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 7,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                             <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 8,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                         ...
                         <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                             <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 9,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 10,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 11,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 12,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 13,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 14,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 15,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 16,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 17,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 18,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 19,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 20,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 21,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 22,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 23,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 24,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 25,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 26,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 27,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 28,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 29,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 30,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 31,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 32,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 33,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 34,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Ejigbo Osun' AND service_name='Decorator' AND state='Osun-State' limit 35,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
