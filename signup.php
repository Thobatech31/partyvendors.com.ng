                                        ...
                                        <div class="card-block">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="md-form form-sm">
                                                            ...
                                                            <input type="text" name="firstname" id="firstname" class="form-control validate" value="<?php echo isset($_POST['firstname'])? $_POST['firstname']: ''; ?>" required/>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="md-form form-sm">
                                                            <i class="fa fa-user prefix"></i>
                                                            <input type="text" name="lastname"  id="lastname" class="form-control validate" value="<?php echo isset($_POST['lastname'])? $_POST['lastname']: ''; ?>" required/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="md-form form-sm">
                                                            <i class="fa fa-user prefix"></i>
                                                            <input type="text" name="username" id="username" class="form-control validate" value="<?php echo isset($_POST['username'])? $_POST['username']: ''; ?>" required/>
