...
<!--Second column-->
                          ...
                          <div class="col-lg-12">
                            <div class="description">
                                ...
                                <hr class="hr-dark">
                                <p class="wow fadeInLeft" data-wow-delay="0.4s">Professional vediographers are experts at capturing those special moments in time that you want to keep forever. With the advanced technologies in digital photography and photo editing today, your photos can be viewed and edited in real-time</p>
                                <br>
...
<!--/.Mask-->
                       ...
                       <h1 id="vediographer"></h1>

             <div class="divider-new" style="margin-top: 80px;">
                <h2 class="h2-responsive" id="vediographer">Tuxedos</h2>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-11 col-xs-11">
                        ...
                        <div class="card">
                            ...
                            <!--Card image-->
                            <div class="view overlay hm-white-slight">
                                <img src="img/jwe4.jpg" id="containerimage" class="img-fluid" alt="">
                                <a>
                                    <div class="mask"></div>
                                </a>
                            </div>
