                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                      <a class="nav-link"><b style="font-size: 18px;"><?php if(isset($_SESSION['email'])){
                            echo $_SESSION['email'];
                            echo '<li>
                                    <form action="Apapawineseller.php" method="POST" role="form">
                                ...
                                if(isset($_POST['logoutcat'])){
                                        session_destroy();
                                        header("location:Apapawineseller.php");
                        ...
                        echo '<li><a target="_blank" href="signupone2.php" class="btn btn-primary">Become A Vendor</a></li>
                                <li><a target="_blank" href="signupone.php" class="btn btn-primary">Become A User</a><a target="_blank" href="login.php" class="btn btn-default">Login</a></li>';
                      }?></b></a>
        ...
        <div class="full-bg-img flex-center">
            <div class="container">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <center>   
                                    <h3 style="color:white; font-weight: bold; margin-top: 20px;">We have amazing Winesellers in Apapa Lagos for your event.</h3>
...
<center>   
                                    <h3 style=" font-weight: bold; ">Apapa Lagos state Winesellers.</h3>
                                    
                                </center>

 <div class="container-fluid">
    <form role="form" action="apapawineseller.php" method="POST">
  <div class="row">
        <div class="col-md-3">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                                 <?php
                                $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 0,1";
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            ...
                            <?php
                                $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 1,1";
                                $result=mysqli_query($mysqli,$query);
                                 while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                             <?php
                                $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State'limit 2,1";
                                $result=mysqli_query($mysqli,$query);
                                while($row=mysqli_fetch_array($result)){
                         ...
                         <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                               <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 3,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                                 <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 4,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                                <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 5,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                              <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 6,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                             <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 7,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                             <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 8,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                         ...
                         <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                             <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 9,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 10,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 11,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 12,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 13,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 14,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 15,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 16,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 17,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 18,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 19,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 20,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 21,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 22,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 23,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 24,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 25,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 26,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 27,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 28,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 29,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 30,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 31,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 32,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 33,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 34,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Apapa Lagos' AND service_name='Wineseller' AND state='Lagos State' limit 35,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
