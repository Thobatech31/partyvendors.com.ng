                ...
                <ul class="nav navbar-nav smooth-scroll">
                    ...
                    <li class="nav-item">
                      ...
                      <a class="nav-link"><b style="font-size: 18px;"><?php if(isset($_SESSION['email'])){
                            echo $_SESSION['email'];
                            echo '<li>
                                    <form action="effon-alaye-ekitiphotogra.php" method="POST" role="form">
        ...
        <div class="full-bg-img flex-center">
            <div class="container">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <center>   
                                    <h3 style="color:white; font-weight: bold; margin-top: 25px;">We have amazing Photographers in Effon-alaye Ekiti State for your event.</h3>
...
<center>   
                                    <h3 style=" font-weight: bold; ">Effon-alaye Ekiti State Photographers.</h3>
                                    
                                </center>

 <div class="container-fluid">
    <form role="form" action="effon-alaye-ekitiphotogra.php" method="POST">
  <div class="row">
        <div class="col-md-3">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                                 <?php
                                $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 0,1";
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            ...
                            <?php
                                $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 1,1";
                                $result=mysqli_query($mysqli,$query);
                                 while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                             <?php
                                $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State'limit 2,1";
                                $result=mysqli_query($mysqli,$query);
                                while($row=mysqli_fetch_array($result)){
                         ...
                         <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                               <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 3,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                                 <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 4,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                                <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 5,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                              <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 6,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                             <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 7,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                             <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 8,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                         ...
                         <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                             <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 9,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 10,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 11,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 12,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 13,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 14,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 15,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 16,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 17,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 18,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 19,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 20,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 21,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 22,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 23,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 24,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 25,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 26,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 27,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 28,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 29,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 30,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 31,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 32,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                           <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 33,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 34,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-12" id="line2">
                            <?php
                                    $query="SELECT cover_image,service_price,service_description,service_name,state FROM service WHERE location='Effon-alaye Ekiti' AND service_name='Photographer' AND state='Ekiti-State' limit 35,1";
                                    $result=mysqli_query($mysqli,$query);
                                    while($row=mysqli_fetch_array($result)){
...
<head>
    ...
    <!-- Your custom styles (optional) -->
    <link href="css/style.css" rel="stylesheet">
    <link rel="stylesheet" href="css/categorycsss.css">
