        ...
        <div class="full-bg-img flex-center">
            <div class="container">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <center>   
                                    <h3 style="color:white; font-weight: bold;">We have amazing Winesellers in Agege Lagos for your event.</h3>
...
<center>   
 ...
 <div class="container-fluid">
    <form role="form" action="booktest.php" method="POST">
  <div class="row">
        <div class="col-md-3">
            <div class="row">
                <div class="col-md-12">
                                ...
                                ?>
                                    <div class="post">
                                        ...
                                        <center>
                                            ...
                                            <button type="submit" name="book1" >Book us</button>
                                        </center>
                                    </div>
