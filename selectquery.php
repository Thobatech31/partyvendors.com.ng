        ...
        <div class="col-md-9 col-sm-12 col-xs-12">
          <div class="container">
            <div class="row">
                ...
                ?>
            <center>
              <form class="form-inline" role="form" action="selectquery.php" method="POST">
                       ...
                       <label for="Country" control-label" ></label><br/>
                        ...
                        <select class="form-control"  name="vendors"  id="vendors" >
                          ...
                          <option value="markup">Make-up artists</option>
                           ...
                           <option value="ushering">Ushering/Security</option>
                          <option value="eventplanner">Event Planner</option>
                          <option value="invitationcards">Invitation Cars/Printin</option>
                    ...
                    <div class="form" > 
                      ...
                      <p id="header">In What Location</p>
                        <select class="form-control" id="select3" name="location">
                          ...
                          <option data-value="Kastina" value="Bakori">Bakori</option>
                          <option data-value="Kastina" value="Batagarawa">Batagarawa</option>
                          <option data-value="Kastina" value="Batsari">Batsari</option>
                          <option data-value="Kastina" value="Baure">Baure</option>
                          <option data-value="Kastina" value="Bindawa">Bindawa</option>
                          <option data-value="Kastina" value="Charanchi">Charanchi</option>
                          <option data-value="Kastina" value="Dan- Musa">Dan- Musa</option>
                          <option data-value="Kastina" value="Dandume">Dandume</option>
                          <option data-value="Kastina" value="Danja">Danja</option>
                          <option data-value="Kastina" value="Daura">Daura</option>
                          <option data-value="Kastina" value=" Dutsi"> Dutsi</option>
                          <option data-value="Kastina" value="Dutsin `ma">Dutsin `ma</option>
                          <option data-value="Kastina" value="Faskar">Faskar</option>
                          <option data-value="Kastina" value="Funtua">Funtua</option>
                          <option data-value="Kastina" value="Ingawa">Ingawa</option>
                          <option data-value="Kastina" value="Jibiya">Jibiya</option>
                          <option data-value="Kastina" value="Kafur">Kafur</option>
                          <option data-value="Kastina" value="Kaita">Kaita</option>
                          <option data-value="Kastina" value="Kankara">Kankara</option>
                          <option data-value="Kastina" value="Kankiya">Kankiya</option>
                          <option data-value="Kastina" value="Katsina">Katsina</option>
                          <option data-value="Kastina" value="Furfi">Furfi</option>
                          <option data-value="Kastina" value="Kusada.Mai aduwa">Kusada.Mai aduwa</option>
                          <option data-value="Kastina" value="Malumfashi">Malumfashi</option>
                          <option data-value="Kastina" value="Mani">Mani</option>
                          <option data-value="Kastina" value="Mash">Mash</option>
                          <option data-value="Kastina" value="Matazu">Matazu</option>
                          <option data-value="Kastina" value="Musawa">Musawa</option>
                          <option data-value="Kastina" value="Rimi">Rimi</option>
                          <option value="Sabuwa">Sabuwa</option>
                          <option data-value="Kastina" value="Safana">Safana</option>
                          <option data-value="Kastina" value="Sandamu">Sandamu</option>
                          <option data-value="Kastina" value="Zango">Zango</option>
                          ...
                          <option data-value="Lagos" value="ifako/ijaye">Ifako/Ijaye  Lagos</option>
                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div id="carousel-example-2"  class="carousel slide carousel-fade no-flex wow fadeIn" data-pause="4.5s" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-item">
                                <img class="img-fluid" src="img/chair3.jpg" id="carousel_image" alt="Second slide">
                                <div class="carousel-caption">
